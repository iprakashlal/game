...
console.log(player.offsetTop, player.offsetLeft); // Y top < 244

var move = 0;
var journeyFlag = "R";

var obstacleMovement = function obstacleMovement() {
  move--;
  ...
  groundObstacle.style.transform = "translateX(".concat(move, "px)");
};
...
var jumpCalc = function jumpCalc() {
